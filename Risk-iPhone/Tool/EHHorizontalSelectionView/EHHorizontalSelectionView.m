...
- (void)startView
{
    ...
    _flowLayout.itemSize = CGSizeMake(SCREEN_WIDTH/4, 40);
...
//划分title的显示个数（这里显示4个）
        ...
        return CGSizeMake(SCREEN_WIDTH/4, frame.size.height);
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    if (_selectedIndexPath)
    {
        ...
        {
            EHHorizontalViewCell * oldCell = (EHHorizontalViewCell*)[collectionView cellForItemAtIndexPath:_selectedIndexPath];
