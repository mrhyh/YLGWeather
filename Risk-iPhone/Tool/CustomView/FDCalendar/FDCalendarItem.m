...
@property (assign, nonatomic) CGFloat FDCalendarItemW;
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _customFrame = frame;
        _FDCalendarItemW = frame.size.width;
        
        
        self.backgroundColor = [UIColor clearColor];
        [self setupCollectionView];
        [self setFrame:CGRectMake(0, 0, _FDCalendarItemW, self.collectionView.frame.size.height + CollectionViewVerticalMargin * 2)];
    }
    return self;
}
...
- (void)setupCollectionView {
    CGFloat itemWidth = (_FDCalendarItemW - CollectionViewHorizonMargin * 2) / 7;
    ...
    CGRect collectionViewFrame = CGRectMake(CollectionViewHorizonMargin, CollectionViewVerticalMargin, _FDCalendarItemW - CollectionViewHorizonMargin * 2, itemHeight * 5);
